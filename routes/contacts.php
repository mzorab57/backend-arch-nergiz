...
// Check if there's an ID in the path (e.g., /api/contacts/1)
        ...
        case 'PUT':
            ...
            if (!$id) {
                if (isset($input['id']) && is_numeric($input['id'])) {
                    ...
                    http_response_code(400);
                    echo json_encode(['error' => 'Contact ID is required for update']);
                    exit;
                }
            }
            // Get JSON input
        ...
        case 'DELETE':
            ...
            if (!$id) {
                if (isset($input['id']) && is_numeric($input['id'])) {
                    ...
                    http_response_code(400);
                    echo json_encode(['error' => 'Contact ID is required for deletion']);
                    exit;
                }
            }
